...
SECRET_REGION = "us-east-1"                  # <-- edit: region of the secret

# --- Everything else: hardcoded ---
SF_USERNAME = "integration.user@yourorg.com"        # <-- edit
SF_PASSWORD = "your-salesforce-password"            # <-- edit (without token appended)
SF_SECURITY_TOKEN = "your-security-token"           # <-- edit
...
def get_sf_client_credentials(secret_name, region):
...
SF_CLIENT_ID, SF_CLIENT_SECRET = get_sf_client_credentials(SECRET_NAME, SECRET_REGION)
...
def get_salesforce_session(cfg):
    ...
    payload = {
        ...
        "password": cfg["password"] + cfg["security_token"],
    }
